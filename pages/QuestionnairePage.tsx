...
import { ArrowRight, ArrowLeft, Send, Sparkles, MapPin, AlertCircle } from 'lucide-react';
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex justify-between items-center pt-10">
              ...
              <button 
                onClick={handleNext}
                disabled={isSubmitting || !answers[step.field]}
              ...
              >
                {isSubmitting ? 'EXISTENCE EN CRÉATION...' : (currentStep === STEPS.length - 1 ? 'PUBLIER MA FICHE' : 'CONTINUER')}
